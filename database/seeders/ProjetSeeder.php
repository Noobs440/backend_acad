...
class ProjetSeeder extends Seeder
{
    ...
    public function run(): void
    {
       TblProjet::create([
            ...
            'image'=>'https://res.cloudinary.com/dmj6r3daf/image/upload/v1754073484/projets/img1.jpeg',
            'soumis'=>'1',
            'status'=>'Pending',
            'user_id'=>'1',
            'tbl_niveau_id'=>'1',
        ...
        TblProjet::create([
            ...
            'image'=>'https://res.cloudinary.com/dmj6r3daf/image/upload/v1754073484/projets/img2.jpeg',
            'status'=>'Approved',
            'soumis'=>'1',
            'user_id'=>'2',
            'tbl_niveau_id'=>'1',
    ...
    TblProjet::create([
        ...
        'image'=>'https://res.cloudinary.com/dmj6r3daf/image/upload/v1754073484/projets/img5.jpeg',
        'status'=>'Pending',
        'soumis'=>'1',
        'user_id'=>'2',
        'tbl_niveau_id'=>'2',
    ...
    TblProjet::create([
        ...
        'image'=>'https://res.cloudinary.com/dmj6r3daf/image/upload/v1754073484/projets/img6.jpeg',
        'soumis'=>'0',
        'status'=>'Approved',
        'user_id'=>'4',
        'tbl_niveau_id'=>'4',
    ...
    TblProjet::create([
        ...
        'image'=>'https://res.cloudinary.com/dmj6r3daf/image/upload/v1754073484/projets/img7.jpeg',
        'status'=>'Approved',
        'soumis'=>'0',
        'user_id'=>'2',
        'tbl_niveau_id'=>'1',
    ...
    TblProjet::create([
        ...
        'image'=>'https://res.cloudinary.com/dmj6r3daf/image/upload/v1754073484/projets/img8.jpeg',
        'soumis'=>'1',
        'status'=>'Rejected',
        'user_id'=>'1',
        'tbl_niveau_id'=>'2',
    ...
    TblProjet::create([
        ...
        'image'=>'https://res.cloudinary.com/dmj6r3daf/image/upload/v1754073484/projets/img9.jpeg',
        'status'=>'Approved',
        'soumis'=>'1',
        'user_id'=>'3',
        'tbl_niveau_id'=>'4',
    ...
    TblProjet::create([
        ...
        'descript_projet' => 'Développement d un système de gestion de la bande passante pour les réseaux d entreprise, permettant de prioriser le trafic réseau et d allouer dynamiquement les ressources en fonction des besoins.',
        'image'=>'https://res.cloudinary.com/dmj6r3daf/image/upload/v1754073484/projets/img10.jpg',
        'soumis'=>'1',
        'status'=>'Approved',
        'user_id'=>'1',
        'tbl_niveau_id'=>'2',
